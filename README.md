...
The function sendLoan is the primary function of this contract. The function accepts a _loanAmount and a _debtorId both of which are local variables of type unsigned integer as paramaters. The function has the following error handlinng:
